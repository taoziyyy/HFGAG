...
def Run(args):
    ...
    for xx, yy in zip(Xs, Ys):
        ...
        for train, test in zip(train_set, test_set):
            ...
            if model_name == "dmis-lab/biobert-v1.1":
                ...
                model_path = '../model/save_model/pubmedbert-attention' + str(iter) + 'model.pth'
            else:
    ...
    if model_name == "dmis-lab/biobert-v1.1":
        ...
        data_plot_f1.to_excel('../result/pubmedbert-att' + str(epochs) + '_F1.xlsx', index=False)
    else:
    ...
    if model_name == "dmis-lab/biobert-v1.1":
        plt.savefig('../result/biobert-att' + str(epochs) + '_F1_Learning_Curve.pdf')
    elif model_name == "microsoft/BiomedNLP-PubMedBERT-base-uncased-abstract-fulltext":
        plt.savefig('../result/pubmedbert-att' + str(epochs) + '_F1_Learning_Curve.pdf')
    else:
