...
def load_documents(text_path, sentence_path, ner_path):
...
#     no_packs = 0
    ...
    while (1):
        try:
            ...
            genes, diseases = seperate_genes_and_follicles(anns)
            ...
            # new_sequences = Generate_sequences_data(sequences, gdas)
