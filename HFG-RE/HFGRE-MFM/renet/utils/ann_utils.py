...
def seperate_genes_and_follicles(tags):
    genes = {}
    follicles = {}
    for tag in tags:
        new_tag = tag[:4]
        ...
        if tag[-1] == "Gene":
            ...
            add_dict(Id, new_tag, follicles)
    return genes, follicles

def change_tags(tags, sent_offset, token_offset):
    new_tags = []
    for tag in tags:
        ...
        new_tag = [sent_no, begin_token_no, end_token_no] + tag[-3:]
