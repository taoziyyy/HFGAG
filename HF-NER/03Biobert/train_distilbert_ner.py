# -*- coding: utf-8 -*-
"""
@Time ： 2023/7/18 下午8:51
@Auth ： zhangtao
@File ：train_biobert_ner.py
@IDE ：PyCharm
@Desc: 
"""
import pandas as pd
...
# 保存数据到文件
with open('save_model/distilbert_metrics.pkl', 'wb') as file:
    pickle.dump(result_data, file)
model.save_pretrained("save_model/distilbert_model_ner")
